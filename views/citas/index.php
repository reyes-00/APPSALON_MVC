<h1 class="nombre-pagina" >Elige tus citas</h1>
...
<div id="app">
  ...
  <div id="paso-2" class="seccion">
    ...
    <form action="" class="formulario">
      ...
      <div class="campo">
        ...
        <input type="date" name="fecha" id="fecha" min="<?php date_default_timezone_set('America/Mexico_City'); echo date("Y-m-d", strtotime('+1 day')); ?>">
      </div>
      <div class="campo">
  ...
  <div id="paso-3" class="seccion contenido_resumen">
    <h2>Resumen</h2>
    <p class="text-center">Confirma que tus datos esten correctos</p>
  </div>

  <div class="paginacion">
    <button id="anterior">&laquo;
      Anterior
    </button>
    <button id="siguiente">
      Siguiente &raquo;
